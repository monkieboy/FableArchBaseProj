            ...
            value: function () {
                return {
                    ...
                    cases: {
                        ...
                        Text: ["string"],
                        VirtualNode: ["string", makeGeneric(FableMap, {
                            Key: "string",
                            Value: "string"
                        }), FableArray(Any)],
...
var Attributes = function (__exports) {
    ...
    var HookHelper = __exports.HookHelper = function () {
        function HookHelper() {
            _classCallCheck$1(this, HookHelper);
        }

        _createClass$1(HookHelper, [{
            key: _Symbol.reflection,
            value: function () {
                return {
    ...
    setType("Fable.Arch.Html.Attributes.HookHelper", HookHelper);
...
var Types$1 = function (__exports) {
    ...
    var calculateModelChanges = __exports.calculateModelChanges = function (initState, update, actions) {
        ...
        return fold(function (s, a_1) {
            return new List$1(execUpdate(s)(a_1), s);
        }, new List$1(), actions);
    };
...
var AppApi = function (__exports) {
    ...
    var mapSubscriber = __exports.mapSubscriber = function (mapModelChanged, mapAction_1, sub, _arg1) {
        if (_arg1.Case === "ActionReceived") {
            ...
            (function (option_1) {
                iterate(sub, defaultArg(option_1, [], function (x) {
                    return [x];
                }));
            })(defaultArg(mapModelChanged(_arg1.Fields[0]), null, function (arg0_1) {
                return new Types$1.AppEvent("ModelChanged", [arg0_1]);
            }));
        }
    };
        ...
        var handleMessage_ = function handleMessage_(post_1) {
            return function (notifySubs) {
                return function (message) {
                    return function (app) {
                        return Types$1.handleMessage(appSpec.Update, appSpec.View, post_1, notifySubs, message, app);
                    };
                };
            };
        };
            ...
            return function (notifySubs_1) {
                return function (tupledArg) {
                    return function (app_1) {
                        return Types$1.handleReplay(appSpec.View, appSpec.Update, post_2, notifySubs_1, tupledArg[0], tupledArg[1], app_1);
                    };
                };
            };
        };
...
function renderSomething(handler, node) {
    ...
    switch ($var10[0]) {
        case 0:
            return createTree(handler, $var10[3], $var10[1], map$1(function (node_1) {
        ...
        case 4:
            return virtualDom.h(node.Fields[0], node.Fields[1], node.Fields[2]);
    }
}
...
setType("Start.Actions", Actions);
function update(model, _arg1) {
  if (_arg1.Case === "B") {
    return "B";
  } else {
    return "A";
...
function view(model) {
  return Tags.div(new List$1())(ofArray([Tags.text("Hello")]));
}
AppApi.start(AppApi.withStartNodeSelector("#app", AppApi.createSimpleApp(Initial, function (model) {
  return view(model);
}, function (model) {
  return function (_arg1) {
    return update(model, _arg1);
  };
})(function (selector) {
...
}((this.Start = this.Start || {}),virtualDom));
